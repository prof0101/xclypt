      ...
      var p = n(4),
        ...
        S = (function () {
          function t(e) {
            ...
            var o = this.container[['inner', 'HTML'].join('')].trim()
            this.container.classList.add('ql-container'),
              (this.container[['inner', 'HTML'].join('')] = ''),
                    ...
                    ;(t.getAttribute('class') || '')
                      ...
                      .forEach(function (n) {
                        if (
                          ...
                          if ('direction' === n)
                            t[['inner', 'HTML'].join('')] = e[n][''] + e[n].rtl
                          else if ('string' == typeof e[n])
                            t[['inner', 'HTML'].join('')] = e[n]
                          else {
                            var r = t.value || ''
                            null != r &&
                              e[n][r] &&
                              (t[['inner', 'HTML'].join('')] = e[n][r])
                          }
                      })
                  })
                },
            ...
            E(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  if ('string' == typeof t)
                    return (
                      (this.container[['inner', 'HTML'].join('')] = t.replace(
                        /\>\r?\n +\</g,
                        '><'
                      )),
                      this.convert()
                ...
                value: function (t) {
                  ...
                  this.cachedText !== e &&
                    ((e.trim().length > 0 || null == this.cachedText) &&
                      ((this.domNode[['inner', 'HTML'].join('')] = t(e)),
