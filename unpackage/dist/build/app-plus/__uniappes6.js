      ...
      r.exports = function (r, n) {
        ...
        if ((e = d ? o : x ? o[h] || a(h, {}) : (o[h] || {}).prototype))
          for (l in n) {
            if (
              ((g = n[l]),
              (p = r.noTargetGet ? (v = i(e, l)) && v.value : e[l]),
              !s(d ? l : h + (x ? '.' : '#') + l, r.forced) && p !== t)
            ) {
      ...
      r.exports =
        ...
        function (r, n) {
          var e = o(this),
            ...
            g = 1
          for (
            s < f && f < s + p && ((g = -1), (s += p - 1), (f += p - 1));
            p-- > 0;

          )
            s in e ? (e[f] = e[s]) : delete e[f], (f += g), (s += g)
          return e
        }
    },
    function (r, n, e) {
        ...
        if (
          (N &&
            ...
            v !== Object.prototype &&
              ...
              (l ||
                i(m) === v ||
                (u ? u(m, v) : 'function' != typeof m[d] && a(m, d, x)),
              c(m, w, !0, !0),
              l && (p[w] = x))),
          'values' == g &&
            I &&
      ...
      e(
        { target: 'Array', proto: !0, forced: !s('splice') },
        {
          splice: function (t, r) {
            ...
            if (((s.length = e), n < e)) {
              for (g = y; g < x - e; g++)
                (h = g + n), (v = g + e) in d ? (d[h] = d[v]) : delete d[h]
              for (g = x; g > x - e + n; g--) delete d[g - 1]
            } else if (n > e)
              for (g = x - e; g > y; g--)
                (h = g + n - 1),
                  (v = g + e - 1) in d ? (d[h] = d[v]) : delete d[h]
      ...
      r.exports = {
        getConstructor: function (r, n, e, s) {
          var l = r(function (r, o) {
              a(r, l, n),
                h(r, { type: n, index: i(null), first: t, last: t, size: 0 }),
                p || (r.size = 0),
                o != t && f(o, r[s], r, e)
            }),
            v = d(n),
            ...
            u(l.prototype, {
              ...
              forEach: function (r) {
                for (
                  var n,
                    e = v(this),
                    o = c(r, arguments.length > 1 ? arguments[1] : t, 3);
                  (n = n ? n.next : e.first);
        ...
        setStrong: function (r, n, e) {
          ...
          s(
            ...
            function () {
              for (var r = u(this), n = r.kind, e = r.last; e && e.removed; )
                e = e.previous
        ...
        },
        {
          toFixed: function (t) {
            var r,
              ...
              h = function (t, r) {
                for (var n = -1, e = r; ++n < 6; )
                  (e += t * p[n]), (p[n] = e % 1e7), (e = f(e / 1e7))
              },
              d = function (t) {
                for (var r = 6, n = 0; --r >= 0; )
                  (n += p[r]), (p[r] = f(n / t)), (n = (n % t) * 1e7)
              },
              x = function () {
                for (var t = 6, r = ''; --t >= 0; )
                  if ('' !== r || 0 === t || 0 !== p[t]) {
    ...
    function (t, r, n) {
      ...
      t.exports =
        ...
        o(function () {
          ...
          ? function (t, r) {
              for (
                var n = a(t), o = arguments.length, s = 1, l = u.f, p = c.f;
                o > s;
    ...
    function (t, r, n) {
      var e = n(5),
        ...
        c = function (t) {
          return function (r) {
            for (
              var n, c = i(r), a = o(c), f = a.length, s = 0, l = [];
              f > s;

            )
              (n = a[s++]), (e && !u.call(c, n)) || l.push(t ? [n, c[n]] : c[n])
            return l
          }
        }
      ...
      o(
        { target: 'Object', stat: !0, sham: !i },
        {
          getOwnPropertyDescriptors: function (r) {
            for (
              var n, e, o = c(r), i = a.f, s = u(o), l = {}, p = 0;
              s.length > p;
        ...
        return [
          ...
          function (t) {
            ...
            for (var l, p = [], g = 0; null !== (l = f(o, c)); ) {
              var v = String(l[0])
              ;(p[g] = v),
                '' === v && (o.lastIndex = a(c, u(o.lastIndex), s)),
                g++
            }
            return 0 === g ? null : p
          },
        ...
        I = i(
          ...
          function () {
            ...
            return null === o
              ...
              : r.global
                ? ('' == String(o[0]) &&
                    (n.lastIndex = x(e, c(n.lastIndex), r.unicode)),
                  { value: o, done: !1 })
        ...
        { target: 'String', proto: !0, forced: A },
        {
          matchAll: function (r) {
            ...
            if (null != r) {
              if (
                l(r) &&
                !~String(u('flags' in E ? r.flags : p.call(r))).indexOf('g')
              )
                throw TypeError('`.matchAll` does not allow non-global regexes')
              if (A) return j.apply(i, arguments)
              if (
                ((e = r[m]) === t && b && 'RegExp' == s(r) && (e = _),
                null != e)
              )
                return a(e).call(r, i)
        ...
        { target: 'String', stat: !0 },
        {
          raw: function (t) {
            for (
              ...
              u.push(String(r[c++])), c < e && u.push(String(arguments[c]))
            return u.join('')
          },
        }
      )
      ...
      o('search', 1, function (r, n, e) {
        return [
          ...
          function (t) {
            ...
            var s = a(o, u)
            return (
              c(o.lastIndex, f) || (o.lastIndex = f), null === s ? -1 : s.index
            )
          },
        ]
      })
            ...
            [
              ...
              function (r, i) {
                ...
                for (var S = 0, O = 0, E = []; O < g.length; ) {
                  ...
                  if (
                    null === j ||
                    (w = h(s(b.lastIndex + (d ? 0 : O)), g.length)) === S
                  )
                    O = f(g, O, x)
                  else {
