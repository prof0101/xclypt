!(function (e) {
  ...
  function (e, t, A) {
    ...
    function a(e, t, A, a, i, n, o, s, r, c) {
      ...
      if (r) {
        ...
        for (var h in r)
          d.call(r, h) && !d.call(u.components, h) && (u.components[h] = r[h])
      }
      if (
        (c &&
        ...
        'function' == typeof getUni
          ...
          : function () {
              var e = function (e) {
                ...
                n = function (e) {
                  return (
                    (!A.test(e) || 'createBLEConnection' === e) &&
                    !~a.indexOf(e)
                  )
                },
                o = function (A) {
                    ...
                    (function (e) {
                      ...
                      if (
                        ((e.postMessage = function (e) {
                          A
                            ? u.postMessage({ data: e, to: t ? A : a })
                            : w({ type: 'UniAppSubNVue', data: e })
                        }),
                        ...
                        ;(e.show = function () {
                          h()
                          for (
                            var t = arguments.length, A = Array(t), a = 0;
                            a < t;
                            a++
                          )
                            A[a] = arguments[a]
              ...
              var F = Object.freeze({
                  ...
                  request: function (t) {
                    ...
                    if (i)
                      for (var g in i)
                        h || 'content-type' !== g.toLowerCase()
                          ? (f[g] = i[g])
                          : ((h = !0), (f['Content-Type'] = i[g]))
                    return (
                      'GET' === o &&
                        a &&
                        (A =
                      ...
                      O.fetch(
                        {
                          ...
                          method: o,
                          headers: f,
                          type: 'json' === r ? 'json' : 'text',
                          body: 'GET' !== o ? P(a, o, f['Content-Type']) : '',
                        },
                        function (t) {
                          var A = t.status,
                      ...
                      if ('success' === t.result) {
                        ...
                        G.getItem(A, function (t) {
                          if ('success' === t.result) {
                            var A = t.data
                            o && A
                              ? ('String' !== o && (A = JSON.parse(A)),
                                e(a) && a({ errMsg: 'getStorage:ok', data: A }))
                  ...
                  removeStorage: function (t) {
                    ...
                    G.removeItem(A, function (t) {
                      'success' === t.result
                        ...
                        : ((t.errMsg = 'removeStorage:fail'), e(i) && i(t)),
                        e(n) && n(t)
                    }),
  ...
  function (e, t, A) {
    ;(Vue.prototype.__$appStyle__ = {}),
      Vue.prototype.__merge_style &&
        Vue.prototype.__merge_style(A(4).default, Vue.prototype.__$appStyle__)
  },
  function (e, t, A) {
    'use strict'
    A.r(t)
        ...
        methods: {
          ...
          postMessage: function () {
            var t =
              ...
              a = JSON.parse(
                JSON.stringify({
                  __message: { __page: this.__page, data: t, keep: A },
                })
              ),
              i = this.__from
  ...
  function (e, t, A) {
    ...
    ;(function (e) {
      this.options.style || (this.options.style = {}),
        ...
        Vue.prototype.__merge_style
          ? Vue.prototype.__merge_style(A(36).default, this.options.style)
      ...
      var u = {
        ...
        filters: {
          distance: function (e) {
            return e > 100
              ? ''.concat(
                  e > 1e3 ? (e / 1e3).toFixed(1) + 'k' : e.toFixed(0),
                  'm | '
                )
              : e > 0
                ? '100m内 | '
        ...
        methods: {
                ...
                function (e) {
                  ;(t.nearLoading = !1),
                    ...
                    e.poiList && e.poiList.length
                      ? (t.fixPois(e.poiList),
                        (t.nearList = t.nearList.concat(e.poiList)),
                        t.fixNearList())
                ...
                function (t) {
                  ;(e.searchLoading = !1),
                    ...
                    t.poiList && t.poiList.length
                      ? (e.fixPois(t.poiList),
                        (e.searchList = e.searchList.concat(t.poiList)))
          ...
          onSearchItemClick: function (e, t) {
            t.stopPropagation(),
              ...
              this.moveToLocation(
                this.searchList[e] && this.searchList[e].location
              )
          },
          ...
          fixPois: function (e) {
            for (var t = 0; t < e.length; t++) {
              ...
              ;(A.name = A.name.replace(/\\/g, '')),
                (A.addressOrigin = A.address.replace(/\\/g, '')),
                (A.address = this.getAddressStart(A) + A.addressOrigin)
            }
          },
                  ...
                  A(
                    ...
                    [
                      A(
                        ...
                        [
                          A('u-image', {
                            staticClass: ['map_center_marker'],
                            attrs: { src: e.positionIcon },
                          }),
                        ],
                        1
                      ),
                    ...
                    [
                      A(
                        'u-text',
                        {
                          ...
                          class: {
                            'map-location-text-active': e.isUserLocation,
                          },
                        },
                        [e._v('')]
                      ),
                  ...
                  A('view', { staticClass: ['nav-cover'] }, [
                    ...
                    A('view', { staticClass: ['title-view', 'flex-r'] }, [
                      ...
                      A(
                        'view',
                        {
                          staticClass: ['btn-done', 'flex-r', 'a-i-c', 'j-c-c'],
                          class: { 'btn-done-disabled': e.disableOK },
                          on: { click: e.doneClick },
                        },
                        [
                          A(
                            'u-text',
                            {
                              staticClass: ['text-done'],
                              class: { 'text-done-disabled': e.disableOK },
                            },
                ...
                [
                  A('view', { staticClass: ['search-bar'] }, [
                    A(
                      'view',
                      {
                        staticClass: ['search-area', 'flex-r', 'a-i-c'],
                      ...
                      [
                        ...
                        A('u-text', { staticClass: ['search-text'] }, [
                          e._v(e._s(e.localize('search_tips'))),
                        ]),
                      ]
                    ),
                  ]),
                    ...
                    : A(
                        ...
                        [
                          ...
                          e.nearLoading
                            ? A(
                                'cell',
                                { appendAsTree: !0, attrs: { append: 'tree' } },
                                [
                                  A(
                                    'view',
                                    {
                  ...
                  e.noNearData
                    ? A(
                        ...
                        [
                          A('u-text', { staticClass: ['no-data'] }, [
                            e._v(e._s(e.localize('no_found'))),
                          ]),
                        ]
                      )
                    : e._e(),
                  e.showSearch
                    ? A('view', { staticClass: ['search-view', 'flex-c'] }, [
                        A(
                          'view',
                          { staticClass: ['search-bar', 'flex-r', 'a-i-c'] },
                          [
                            A(
                              'view',
                              {
                              ...
                              [
                                A('u-input', {
                                  ...
                                  attrs: {
                                    focus: !0,
                                    placeholder: e.localize('search_tips'),
                                  },
                              ...
                              'u-text',
                              {
                                ...
                                class: {
                                  'search-tab-item-active':
                                    t.method === e.searchMethod,
                                },
                                on: {
                                  click: function (A) {
                                    e.searchMethod = e.searchLoading
                                      ? e.searchMethod
                                      : t.method
                                  },
                                },
                        ...
                        e.noSearchData
                          ? A(
                              'view',
                              { staticClass: ['flex-fill', 'flex-r', 'j-c-c'] },
                              [
                                A(
                                  'u-text',
                                  {
                                    staticClass: ['no-data', 'no-data-search'],
                                  },
                                  [e._v(e._s(e.localize('no_found')))]
                                ),
                              ]
  ...
  function (e, t, A) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.log = function (e) {
        for (
          var t = arguments.length, A = new Array(t > 1 ? t - 1 : 0), a = 1;
          a < t;
          a++
        )
          A[a - 1] = arguments[a]
