  ...
  function (e, t, n) {
    ...
    function a(e, t, n, a, o, r, i, s, c, u) {
      ...
      if (c) {
        ...
        for (var p in c)
          d.call(c, p) && !d.call(f.components, p) && (f.components[p] = c[p])
      }
      if (
        (u &&
      ...
      (a =
        'function' == typeof getUni
          ...
          : function () {
                      ...
                      : t(
                          new Promise(function (e, t) {
                            n.apply(
                              void 0,
                              [
                                Object.assign({}, i, { success: e, fail: t }),
                              ].concat(o)
                            ),
              ...
              var T = weex.requireModule('dom'),
                I = weex.requireModule('globalEvent'),
                P = []
              function D(e) {
                'function' == typeof e && (this.isUniAppReady ? e() : P.push(e))
              }
              I.addEventListener('plusMessage', function (e) {
              ...
              var j = Object.freeze({
                  ...
                  request: function (t) {
                    ...
                    if (o)
                      for (var h in o)
                        p || 'content-type' !== h.toLowerCase()
                          ? (g[h] = o[h])
                          : ((p = !0), (g['Content-Type'] = o[h]))
                    return (
                      'GET' === i &&
                        a &&
                        (n =
                      ...
                      x.fetch(
                        {
                          ...
                          body: 'GET' !== i ? U(a, i, g['Content-Type']) : '',
                        },
                        function (t) {
                          var n = t.status,
      ...
      var n = {
        ...
        methods: {
          ...
          localize: function (e) {
            ...
            return r('messages')[e] || r(n)[e] || r(a)[e] || r(o)[e] || e
          },
        },
      }
      t.default = n
          ...
          methods: {
            ...
            gallery: function () {
              ...
              e.gallery.pick(
                ...
                function (n) {
                  n.code !==
                    ('android' === weex.config.env.platform.toLowerCase()
                      ? 12
                      : -2) && e.nativeUI.toast(t.localize('fail'))
                },
                {
                  multiple: !1,
                  system: !1,
              ...
              [
                ...
                n(
                  ...
                  [
                    ...
                    n('u-text', { staticClass: ['image-flash-text'] }, [
                      e._v(
                        e._s(
                          e.enabledFlash
                            ? e.localize('flash.off')
                            : e.localize('flash.on')
                        )
                      ),
                    ]),
