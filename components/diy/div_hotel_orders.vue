<template>
  <view class="diy_details diy_div_hotel_orders">
    <view v-if="Object.keys(obj).length !== 0" class="warp">
      <view class="container">
        <view class="row">
          ...
          <view
            v-if="$check_field('get', 'days_of_stay')"
            class="col-12 col-md-6"
          >
            <view class="diy_title">
              <span>住店天数:</span>
          ...
          <view
            v-if="$check_field('get', 'total_hotel_stay')"
            class="col-12 col-md-6"
          >
            <view class="diy_title">
              <span>住店总额:</span>
          ...
          <view
            v-if="$check_field('get', 'final_payment_for_hotel_stay')"
            class="col-12 col-md-6"
          >
            <view class="diy_title">
              <span>住店尾款:</span>
            ...
            <view class="diy_field diy_text">
              <text>
                {{ obj['final_payment_for_hotel_stay'] }}
              </text>
            </view>
          </view>
          <view
            v-if="$check_field('get', 'time_of_stay')"
            class="col-12 col-md-6"
          >
            <view class="diy_title">
              <span>住店时间:</span>
            ...
            <view class="diy_field diy_date">
              <text>
                {{ $toTime(obj['time_of_stay'], 'yyyy-MM-dd') }}
              </text>
            </view>
          </view>
          <view
            v-if="$check_field('get', 'hotel_remarks')"
            class="col-12 col-md-6"
          >
            <view class="diy_title">
              <span>住店备注:</span>
...
export default {
  ...
  methods: {
    ...
    async get_obj_by_id() {
      var res = await this.$get(
        getApp().globalData.host + '/api/hotel_orders/get_obj',
        {
          hotel_orders_id: this.query.hotel_orders_id,
        }
      )
  ...
  async onLoad() {
    ...
    } else if (this.query['hotel_orders_id'] !== 0) {
