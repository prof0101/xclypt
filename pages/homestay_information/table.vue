<template>
  <view
    class="page_homestay_information diy_table diy_table_tml"
    id="homestay_information_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator
                class="nav_left"
                url="/pages/homestay_information/view?"
                v-if="
                  user_group == '管理员' ||
                  $check_action('/homestay_information/table', 'add') ||
            ...
            <view class="warp">
              <view class="container">
                <view v-for="(o, i) in list" class="row box_style">
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'homestay_telephone_number')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>民宿电话</span>
                  ...
                  <view
                    class="col"
                    v-if="1 && $check_field('get', 'homestay_pictures')"
                  >
                    <view class="view">
                      ...
                      <view class="diy_field diy_img">
                        <img
                          :src="$fullUrl(o['homestay_pictures'])"
                          width="100%"
                          height="100"
                        />
                      </view>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'homestay_prices')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>民宿价格</span>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'homestay_details')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>民宿详情</span>
                      ...
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button
                          ...
                          v-if="
                            ...
                            $check_action('/homestay_information/view', 'del')
                          "
                        >
                          删除
                        </button>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    <navigator
                      ...
                      v-if="
                        user_group == '管理员' ||
                        $check_action('/homestay_information/table', 'set') ||
                        $check_action('/homestay_information/view', 'set') ||
                        $check_action('/homestay_information/view', 'get')
                      "
                    ...
                    <a
                      ...
                      size="mini"
                      class="btn btn-primary"
                      v-if="$check_action('/homestay_orders/view', 'add')"
                      @click="to_form('/pages/homestay_orders/view', o)"
                    >
                      <span>民宿预订</span>
                    </a>
                  </view>
