<template>
  <view
    class="page_homestay_information diy_list diy_list_page div_list_tml"
          ...
          <view>
            <view class="">
              ...
              <uni-search-bar
                placeholder="搜索民宿名称"
                @confirm="search_"
                @cancel="search_cancel('homestay_name')"
                cancelText="取消"
                @input="input($event, 'homestay_name')"
              >
                <uni-icons
                  slot="searchIcon"
                  color="#999999"
              ...
              <uni-search-bar
                placeholder="搜索民宿编号"
                @confirm="search_"
                @cancel="search_cancel('homestay_id')"
                cancelText="取消"
                @input="input($event, 'homestay_id')"
              >
                <uni-icons
                  slot="searchIcon"
                  color="#999999"
    ...
    <view class="warp">
      <view class="container">
        <view v-for="(o, i) in list" class="row box_style">
          ...
          <view class="col" v-if="1 && $check_field('get', 'homestay_name')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>民宿名称</span>
              </view>
          ...
          <view class="col" v-if="1 && $check_field('get', 'homestay_id')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>民宿编号</span>
              </view>
          ...
          <view class="col" v-if="0 && $check_field('get', 'homestay_prices')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>民宿价格</span>
              </view>
          ...
          <view class="col" v-if="0 && $check_field('get', 'homestay_details')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>民宿详情</span>
              </view>
          ...
          <view class="uni-padding-wrap uni-common-mt">
            <navigator
              :url="
                './details?homestay_information_id=' +
...
json
    ...
    get_user_merchant_users(id) {
      ...
      let ret = ''
      for (let i = 0; i < script.obj.length; i++) {
        if (obj[i].user_id == id) {
...
.page_homestay_information .warp {
  display: flex;
