<template>
  <view
    class="page_hotel_information diy_table diy_table_tml"
    id="hotel_information_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                <uni-forms-item label="酒店名称" name="hotel_name">
                  <uni-easyinput
                    type="text"
                ...
                <uni-forms-item label="酒店类别" name="hotel_category">
                  <uni-easyinput
                    type="text"
                    v-model="query.hotel_category"
                    placeholder="酒店类别"
                  />
                </uni-forms-item>
              </uni-forms>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator
                class="nav_left"
                url="/pages/hotel_information/view?"
                v-if="
                  user_group == '管理员' ||
                  $check_action('/hotel_information/table', 'add') ||
            ...
            <view class="warp">
              <view class="container">
                <view v-for="(o, i) in list" class="row box_style">
                  ...
                  <view
                    class="col"
                    v-if="1 && $check_field('get', 'hotel_name')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>酒店名称</span>
                  ...
                  <view
                    class="col"
                    v-if="1 && $check_field('get', 'hotel_pictures')"
                  >
                    <view class="view">
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'hotel_star_rating')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>酒店星级</span>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'hotel_category')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>酒店类别</span>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'room_type')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>房间类型</span>
                  ...
                  <view
                    class="col"
                    v-if="1 && $check_field('get', 'one_night_amount')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>一晚金额</span>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'hotel_phone_number')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>酒店电话</span>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'hotel_introduction')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>酒店介绍</span>
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'hotel_address')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>酒店地址</span>
                    ...
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button
                          ...
                          v-if="
                            user_group == '管理员' ||
                            $check_action('/hotel_information/table', 'del') ||
                            $check_action('/hotel_information/view', 'del')
                          "
                        >
                          删除
                        </button>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    <navigator
                      ...
                      v-if="
                        user_group == '管理员' ||
                        $check_action('/hotel_information/table', 'set') ||
                        $check_action('/hotel_information/view', 'set') ||
                        $check_action('/hotel_information/view', 'get')
                      "
                    ...
                    <a
                      ...
                      size="mini"
                      class="btn btn-primary"
                      v-if="$check_action('/hotel_orders/view', 'add')"
                      @click="to_form('/pages/hotel_orders/view', o)"
                    >
                      <span>酒店预定</span>
                    </a>
                  </view>
