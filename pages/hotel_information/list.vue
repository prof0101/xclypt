<template>
  <view
    class="page_hotel_information diy_list diy_list_page div_list_tml"
    id="hotel_information_list"
  >
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-search-bar
                placeholder="搜索酒店名称"
                @confirm="search_"
                @cancel="search_cancel('hotel_name')"
                cancelText="取消"
                @input="input($event, 'hotel_name')"
              >
                <uni-icons
                  slot="searchIcon"
                  color="#999999"
              ...
              <uni-search-bar
                placeholder="搜索酒店类别"
                @confirm="search_"
                @cancel="search_cancel('hotel_category')"
                cancelText="取消"
                @input="input($event, 'hotel_category')"
              >
                <uni-icons
                  slot="searchIcon"
                  color="#999999"
    ...
    <view class="warp">
      <view class="container">
        <view v-for="(o, i) in list" class="row box_style">
          ...
          <view class="col" v-if="1 && $check_field('get', 'hotel_name')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>酒店名称</span>
              </view>
          ...
          <view class="col" v-if="1 && $check_field('get', 'hotel_pictures')">
            <view class="view">
          ...
          <view class="col" v-if="0 && $check_field('get', 'hotel_category')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>酒店类别</span>
              </view>
          ...
          <view class="col" v-if="0 && $check_field('get', 'room_type')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>房间类型</span>
              </view>
          ...
          <view class="col" v-if="1 && $check_field('get', 'one_night_amount')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>一晚金额</span>
              </view>
          ...
          <view class="col" v-if="0 && $check_field('get', 'hotel_address')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>酒店地址</span>
              </view>
          ...
          <view class="uni-padding-wrap uni-common-mt">
            <navigator
              :url="
                './details?hotel_information_id=' + o['hotel_information_id']
              "
