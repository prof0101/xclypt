<template>
  <view
    class="page_hotel_information diy_detail diy_detail--new"
    id="hotel_information_details"
  >
    <view class="warp">
      <view class="container-fluid">
        <view class="row">
          ...
          <view v-if="$check_field('get', 'hotel_name')" class="col-12 col-6">
            <view class="view">
              <view class="diy_title">
                <span>酒店名称</span>
              </view>
          ...
          >
            <view class="view">
              ...
              <view class="diy_field diy_img">
                <img :src="$fullUrl(obj['hotel_pictures'])" />
              </view>
            </view>
          </view>
          <view
        ...
        <view class="row">
          <view class="col">
            <button
              ...
              v-if="$check_action('/hotel_orders/edit', 'add')"
            ...
            <navigator
              ...
              class="btn link"
              :url="
                '/pages/comment/edit?source_table=hotel_information&source_field=hotel_information_id&source_id=' +
                obj['hotel_information_id']
              "
            >
              评论
            </navigator>
          ...
          if (res.result) {
            ...
            this.$post(
              '~/api/hotel_information/set?hotel_information_id=' +
                _this.obj['hotel_information_id'],
              {
                praise_len,
              },
              (res) => {
