        ...
        <view>
          <view class="">
            <uni-forms :modelValue="form" v-if="is_view()">
              ...
              <uni-forms-item
                v-if="
                  $check_field('get', 'merchant_phone_number') ||
                  $check_field('add', 'merchant_phone_number') ||
                  $check_field('set', 'merchant_phone_number')
                "
                label="商家电话"
                ...
                <uni-easyinput
                  ...
                  v-if="
                    ...
                    (!form['merchant_users_id'] &&
                      $check_field('add', 'merchant_phone_number'))
                  "
                  :disabled="disabledObj['merchant_phone_number_isDisabled']"
                />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get', 'merchant_phone_number')">
                  {{ form['merchant_phone_number'] }}
                </text>
              </uni-forms-item>
            ...
            <view
              class="form_button"
              v-if="
                $check_action('/merchant_users/view', 'set') ||
                $check_action('/merchant_users/view', 'add') ||
                $check_option('/merchant_users/table', 'examine')
              "
            >
              <button
                size="mini"
...
请求参数
    ...
    successChoose(filePath, type) {
      uni.uploadFile({
        url: getApp().globalData.host + '/api/merchant_users/upload', //仅为示例，非真实的接口地址
        filePath,
        name: 'file',
    ...
    close_(type) {
      ...
      if (type == 'merchant_phone_number')
        this['merchant_phone_number'] = this.form['merchant_phone_number'] = ''
    },
    submit_() {
      if (this['merchant_name'] !== null)
        this.form['merchant_name'] = this['merchant_name']
      if (this['merchant_phone_number'] !== null)
        this.form['merchant_phone_number'] = this['merchant_phone_number']
