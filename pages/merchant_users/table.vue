<template>
  <view
    class="page_merchant_users diy_table diy_table_tml"
    id="merchant_users_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                <uni-forms-item label="商家名称" name="merchant_name">
                  <uni-easyinput
                    type="text"
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator
                class="nav_left"
                url="/pages/merchant_users/view?"
                v-if="
                  user_group == '管理员' ||
                  $check_action('/merchant_users/table', 'add') ||
            ...
            <view class="warp">
              <view class="container">
                <view v-for="(o, i) in list" class="row">
                  <view
                    v-if="1 && $check_field('get', 'merchant_name')"
                    class="col"
                  >
                    <view class="view">
                  ...
                  <view
                    v-if="0 && $check_field('get', 'merchant_phone_number')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                    ...
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button
                          ...
                          v-if="
                            user_group == '管理员' ||
                            $check_action('/merchant_users/table', 'del') ||
                            $check_action('/merchant_users/view', 'del')
                          "
                        >
                          删除
                        </button>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    <navigator
                      :url="
                        '/pages/merchant_users/view?' + field + '=' + o[field]
                      "
                      v-if="
                        user_group == '管理员' ||
                        $check_action('/merchant_users/table', 'set') ||
                        $check_action('/merchant_users/view', 'set') ||
                        $check_action('/merchant_users/view', 'get')
                      "
