<template>
  <view
    class="page_restaurant_information diy_table diy_table_tml"
    id="restaurant_information_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                ...
                <uni-forms-item label="餐厅类型" name="restaurant_type">
                  <uni-easyinput
                    type="text"
                    v-model="query.restaurant_type"
                    placeholder="餐厅类型"
                  />
                </uni-forms-item>
              </uni-forms>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator
                class="nav_left"
                url="/pages/restaurant_information/view?"
                v-if="
                  user_group == '管理员' ||
                  $check_action('/restaurant_information/table', 'add') ||
            ...
            <view class="warp">
              <view class="container">
                <view v-for="(o, i) in list" class="row box_style">
                  ...
                  <view
                    class="col"
                    v-if="0 && $check_field('get', 'restaurant_id')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>餐厅编号</span>
                  ...
                  <view
                    class="col"
                    v-if="1 && $check_field('get', 'restaurant_image')"
                  >
                    <view class="view">
                  ...
                  <view
                    class="col"
                    v-if="1 && $check_field('get', 'restaurant_type')"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                        <span>餐厅类型</span>
                      ...
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button
                          ...
                          v-if="
                            ...
                            $check_action('/restaurant_information/view', 'del')
                          "
                        >
                          删除
                        </button>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    <navigator
                      ...
                      v-if="
                        user_group == '管理员' ||
                        $check_action('/restaurant_information/table', 'set') ||
                        $check_action('/restaurant_information/view', 'set') ||
                        $check_action('/restaurant_information/view', 'get')
                      "
                    ...
                    <a
                      ...
                      size="mini"
                      class="btn btn-primary"
                      v-if="$check_action('/restaurant_orders/view', 'add')"
                      @click="to_form('/pages/restaurant_orders/view', o)"
                    >
                      <span>餐厅预订</span>
                    </a>
                  </view>
