<template>
  <view
    class="page_regular_users diy_table diy_table_tml"
    id="regular_users_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="warp">
              <view class="container">
                <view v-for="(o, i) in list" class="row">
                  <view
                    v-if="1 && $check_field('get', 'user_name')"
                    class="col"
                  >
                    <view class="view">
                  ...
                  >
                    <view class="view">
                      ...
                      <div class="diy_field diy_phone text">
                        <text>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    <navigator
                      :url="
                        '/pages/regular_users/view?' + field + '=' + o[field]
                      "
                      v-if="
                        user_group == '管理员' ||
