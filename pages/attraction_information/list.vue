<template>
  <view
    class="page_attraction_information diy_list diy_list_page div_list_tml"
    id="attraction_information_list"
  >
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-search-bar
                placeholder="搜索景点名称"
                @confirm="search_"
                @cancel="search_cancel('attraction_name')"
                cancelText="取消"
                @input="input($event, 'attraction_name')"
              >
                <uni-icons
                  slot="searchIcon"
                  color="#999999"
              ...
              <uni-search-bar
                placeholder="搜索景点电话"
                @confirm="search_"
                @cancel="search_cancel('tourist_attraction_phone_number')"
                cancelText="取消"
                @input="input($event, 'tourist_attraction_phone_number')"
              >
                <uni-icons
                  slot="searchIcon"
                  color="#999999"
    ...
    <view class="warp">
      <view class="container">
        <view v-for="(o, i) in list" class="row box_style">
          ...
          <view class="col" v-if="1 && $check_field('get', 'attraction_name')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>景点名称</span>
              </view>
          ...
          <view
            class="col"
            v-if="1 && $check_field('get', 'scenic_spot_pictures')"
          >
            <view class="view">
              ...
              <view class="diy_field diy_img">
                <img
                  :src="$fullUrl(o['scenic_spot_pictures'])"
                  width="100%"
                  height="100"
                />
              </view>
          ...
          <view class="col" v-if="1 && $check_field('get', 'admission_price')">
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>门票价格</span>
              </view>
          ...
          <view
            class="col"
            v-if="0 && $check_field('get', 'tourist_attraction_phone_number')"
          >
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>景点电话</span>
          ...
          <view
            class="col"
            v-if="0 && $check_field('get', 'attraction_address')"
          >
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>景点地址</span>
          ...
          <view
            class="col"
            v-if="0 && $check_field('get', 'introduction_to_scenic_spots')"
          >
            <view class="view">
              <view class="diy_title" v-if="true">
                <span>景点简介</span>
          ...
          <view class="uni-padding-wrap uni-common-mt">
            <navigator
              :url="
                './details?attraction_information_id=' +
...
.page_attraction_information .warp {
  display: flex;
