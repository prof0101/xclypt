<template>
  <view
    class="page_attraction_information diy_table diy_table_tml"
    id="attraction_information_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator
                class="nav_left"
                url="/pages/attraction_information/view?"
                v-if="
                  user_group == '管理员' ||
                  $check_action('/attraction_information/table', 'add') ||
              ...
              <view class="container">
                <view v-for="(o, i) in list" class="row box_style">
                  ...
                  <view
                    class="col"
                    v-if="
                      0 && $check_field('get', 'introduction_to_scenic_spots')
                    "
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                      ...
                      <view class="diy_field diy_text text">
                        <span>
                          {{ o['introduction_to_scenic_spots'] }}
                        </span>
                      </view>
                    </view>
                  </view>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    ...
                    <a
                      ...
                      size="mini"
                      class="btn btn-primary"
                      v-if="$check_action('/ticket_orders/view', 'add')"
                      @click="to_form('/pages/ticket_orders/view', o)"
                    >
                      <span>门票预订</span>
                    </a>
                  </view>
