<template>
  <view
    class="page_homestay_orders diy_table diy_table_tml"
    id="homestay_orders_table"
  >
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                <uni-forms-item label="民宿名称" name="homestay_name">
                  <uni-easyinput
                    type="text"
                ...
                <uni-forms-item label="民宿编号" name="homestay_id">
                  <uni-easyinput
                    type="text"
                    v-model="query.homestay_id"
                    placeholder="民宿编号"
                  />
                </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator
                class="nav_left"
                url="/pages/homestay_orders/view?"
                v-if="
                  user_group == '管理员' ||
                  $check_action('/homestay_orders/table', 'add') ||
            ...
            <view class="warp">
              <view class="container">
                <view v-for="(o, i) in list" class="row">
                  ...
                  <view
                    v-if="1 && $check_field('get', 'homestay_name')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                  ...
                  <view
                    v-if="1 && $check_field('get', 'homestay_id')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                  ...
                  <view
                    v-if="1 && $check_field('get', 'homestay_prices')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                  ...
                  <view
                    v-if="0 && $check_field('get', 'accommodation_days')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                  ...
                  <view
                    v-if="
                      0 && $check_field('get', 'total_accommodation_amount')
                    "
                    class="col"
                  >
                    <view class="view">
                  ...
                  <view
                    v-if="
                      0 && $check_field('get', 'final_payment_for_homestays')
                    "
                    class="col"
                  >
                    <view class="view">
                      ...
                      <view class="diy_field diy_text text">
                        <text>
                          {{ o['final_payment_for_homestays'] }}
                        </text>
                      </view>
                    </view>
                  </view>
                  <view
                    v-if="0 && $check_field('get', 'accommodation_time')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                      ...
                      <view class="diy_field diy_date text">
                        <text>
                          {{ $toTime(o['accommodation_time'], 'yyyy-MM-dd') }}
                        </text>
                      </view>
                    </view>
                  </view>
                  <view
                    v-if="0 && $check_field('get', 'homestay_address')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                  ...
                  <view
                    v-if="0 && $check_field('get', 'order_remarks')"
                    class="col"
                  >
                    <view class="view">
                      <view class="diy_title" v-if="true">
                    ...
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button
                          ...
                          v-if="
                            user_group == '管理员' ||
                            $check_action('/homestay_orders/table', 'del') ||
                            $check_action('/homestay_orders/view', 'del')
                          "
                        >
                          删除
                        </button>
                  ...
                  <view class="uni-padding-wrap uni-common-mt">
                    <navigator
                      :url="
                        '/pages/homestay_orders/view?' + field + '=' + o[field]
                      "
                      v-if="
                        user_group == '管理员' ||
                        $check_action('/homestay_orders/table', 'set') ||
                        $check_action('/homestay_orders/view', 'set') ||
                        $check_action('/homestay_orders/view', 'get')
                      "
